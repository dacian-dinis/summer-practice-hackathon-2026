...
const sports = [
  ...
  { name: "Jogging", minGroup: 2, maxGroup: 12 },
  { name: "Cycling", minGroup: 2, maxGroup: 10 },
  { name: "Running", minGroup: 2, maxGroup: 16 },
  { name: "Yoga", minGroup: 2, maxGroup: 20 },
  { name: "Hiking", minGroup: 2, maxGroup: 14 },
] as const;
...
const venues = [
  ...
  },
  {
    ...
    lng: 26.0838,
    pricePerHour: 0,
    address: "Șos. Kiseleff",
    sports: ["Jogging", "Running", "Cycling", "Yoga"],
  },
  {
    city: "bucharest",
  ...
  },
  {
    ...
    sports: ["Jogging", "Cycling", "Running"],
  },
  {
    city: "bucharest",
    name: "Pădurea Băneasa",
    lat: 44.5245,
    lng: 26.0805,
    pricePerHour: 0,
    address: "Șos. București-Ploiești",
